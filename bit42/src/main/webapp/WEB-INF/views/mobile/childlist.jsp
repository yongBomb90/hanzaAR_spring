...
<h1>등록된아이는 총 ${cri.total}명 입니다 </h1>
 <button class="mbtn btn btn-primary btn-lg" 
               onClick="self.location='/mobile/child/register'"
...
<ul class="pagination pagination-lg" >
   <c:if test="${cri.prev}">
            <li>
               <a href="/mobile/childlist/${(cri.startpage-1)}" >&laquo;</a>
       ...
       <c:forEach begin="${cri.startpage}" end="${cri.endpage }" var="idx">
            <li
               ...
               <a href="/mobile/childlist/${idx}"  >${idx}</a>
            </li>
       </c:forEach>

         <c:if test="${cri.next}">
            <li>
               <a href="/mobile/childlist/${(cri.endpage+1)}" >&raquo;</a>
            </li>
         </c:if>
      </ul>
</div>
  ...
  <div class="modal modal1">
      <div class="modal-content col-md-6 col-md-offset-3"style="margin-top: 10%">
            ...
            <div class="modal-body">
         			 <div id="dropzone" >
                           <img style=" width:239px; height:239px; margin-left: 3%; margin-top: 0%"  id="thumImg" src=""> 
