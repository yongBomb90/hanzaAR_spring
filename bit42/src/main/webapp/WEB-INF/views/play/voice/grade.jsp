...
<div class="property" style="height: 1000px; background-color: white;">
<div class="container">
...
$.get("/hanza/gradecnt/"+uri,function(data){
	...
	for(var i=1; i<=data; i++){
		if(i <data){
    		if((i%8) == 0){
    			str = str+ '<a href="/play/voice/study/'+curgrade+','+i+'" ><button class="btn btn-danger btn-lg startbtn" cusid="'+i+'">'+i+'단계</button></a><br><br>'
            }else{
        		str = str+ '<a href="/play/voice/study/'+curgrade+','+i+'" ><button class="btn btn-danger btn-lg startbtn" cusid="'+i+'">'+i+'단계</button></a>>>>'
            }
    	}
    	else{
    		if(curgrade == '${childVO.clevel}'){
   			 str = str+ '<a href="/play/voice/study/'+curgrade+','+i+'" ><button class="btn btn-warning btn-lg startbtn" cusid="'+i+'">'+i+'단계(아이단계)</button></a>'
   	     }else{
   			 str = str+ '<a href="/play/voice/study/'+curgrade+','+i+'" ><button class="btn btn-danger btn-lg startbtn" cusid="'+i+'">'+i+'단계</button></a>'
